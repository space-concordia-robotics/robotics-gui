...
from useful import Log_browser
from tables import *
...
class Ui_MainWindow(QtWidgets.QWidget):
    ...
    def setupUi(self, MainWindow):
        ...
        self.command_listener_checkbox = QtWidgets.QCheckBox(
            self.layoutWidget2)
        self.command_listener_checkbox.setObjectName(
            "command_listener_checkbox")
        ...
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.LabelRole,
                                    self.fan2_speed_input)
        self.label = QtWidgets.QLabel(self.layoutWidget4)
        self.label.setObjectName("label")
        self.formLayout_2.setWidget(0, QtWidgets.QFormLayout.LabelRole,
                                    self.label)

        self.pds_table = Pds_table(self.width, self.height, self.parent,
