...
class Pds_Ui(QtWidgets.QWidget):
    ...
    def setupUi(self, MainWindow):
        ...
        self.pds_table = Pds_table(
            self.width, self.height, self.parent, self.width / 1.45, self.height / 2.7
        )
        ...
        self.list_commands_button.setGeometry(
            QtCore.QRect(
                int(self.width / 2),
                int(self.height / 5.14),
                int(self.width / 14.66),
                int(self.height / 15.21),
            )
        )
        ...
        self.layoutWidget2.setGeometry(
            QtCore.QRect(
                int(self.width / 3.49),
                int(self.height / 21.6),
                int(self.width / 12.39),
                int(self.height / 10.69),
            )
        )
        ...
        self.formLayout.setWidget(
            1, QtWidgets.QFormLayout.LabelRole, self.fan1_speed_input
        )
        ...
        self.formLayout_2.setWidget(
            1, QtWidgets.QFormLayout.LabelRole, self.fan2_speed_input
        )
    ...
    def retranslateUi(self):
        ...
        self.reset_general_flags_button.setText(
            _translate("MainWindow", "Reset General\n" "Flags")
        )
        self.reset_current_flags_button.setText(
            _translate("MainWindow", "Reset Current\n" "Flags")
        )
        ...
        self.command_listener_checkbox.setText(
